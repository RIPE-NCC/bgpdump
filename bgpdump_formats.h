...
#define BGPDUMP_SUBTYPE_TABLE_DUMP_V2_IPV4_UNICAST      2
#define BGPDUMP_SUBTYPE_TABLE_DUMP_V2_MULTIPROTOCOL     3
...
#define BGPDUMP_SUBTYPE_ZEBRA_BGP_STATE_CHANGE32	5  /* BGP4MP_STATE_CHANGE_32BIT_AS */
